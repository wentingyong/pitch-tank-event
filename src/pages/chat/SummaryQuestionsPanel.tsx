  ...
  return (
    <GlassCard tone="frame" size="md" className="mt-3">
      <div className="flex items-start gap-3">
        <Sparkles size={20} strokeWidth={1.75} className="text-pt-blue shrink-0 mt-0.5" />
      ...
      <ul className="mt-4 divide-y divide-white/8">
        {questions.map((q) => {
          ...
          return (
            ...
            >
              <span className="font-display font-semibold text-pt-blue text-[12.5px] num shrink-0 w-9">
                [{displayCount}]
              </span>
